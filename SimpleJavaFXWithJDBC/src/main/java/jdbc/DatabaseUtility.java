...
public class DatabaseUtility {
    ...
    // private static final String CONNECTION_STRING ="jdbc:mysql://localhost:3306/bluevelvet_music_store?useSSL=true";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "123456";
    private static final String CONNECTION_STRING ="jdbc:mysql://localhost:3306/bluevelvet_music_store";
